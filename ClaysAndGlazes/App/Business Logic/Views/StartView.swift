...
class StartView: UIView {
    ...
    let text = "Приложение содержит справочную информацию о характеристиках различных масс и их сочетаниях с базовыми глазурями при различных температурах обжига.\n\nВсе данные взяты из разрозненных открытых источников и сведены в этом приложении в удобном виде.\n\n"
